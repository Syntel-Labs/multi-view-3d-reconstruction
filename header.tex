...
% pandoc --from=markdown+implicit_figures+link_attributes hoja-01.md -o hoja-01.pdf --pdf-engine=xelatex -V geometry:top=0.67in -V geometry:bottom=0.67in -V geometry:left=0.85in -V geometry:right=0.85in -H  ../../../header.tex --resource-path=.:images:./images
% pandoc --from=markdown+implicit_figures+link_attributes hoja-02.md -o hoja-02.pdf --pdf-engine=xelatex -V geometry:top=0.67in -V geometry:bottom=0.67in -V geometry:left=0.85in -V geometry:right=0.85in -H  ../../../header.tex --resource-path=.:images:./images
